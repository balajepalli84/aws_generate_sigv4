...
def handler(ctx, data: io.BytesIO = None):
    try:
        ...
        if method == "GET":
            ...
            return {"status": "success", "data": response.text}  # Only return data
        ...
        # Signature validation for PUT requests
            ...
            secret_key = "cy/o7/K+UH4=" # generate secret key
        ...
        return {"status": "error", "message": "Invalid method. Only GET or PUT are supported."}
...
def build_put_signature(http_headers, request_url, host, region_name):
    ...
    aws_secret_access_key = "cy/oVPonGLF4UH4="
...
def validate_signature(http_headers, request_url, host, region_name):
    ...
    aws_access_key_id = "34af0a6977a499883e42e81b3e609b61dff93ea3"
    aws_secret_access_key = "cy/o7/+kIUVPonGLF4UH4="
